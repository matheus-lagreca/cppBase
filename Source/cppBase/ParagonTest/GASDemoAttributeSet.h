 ...
 */
UCLASS()
class CPPBASE_API UGASDemoAttributeSet : public UAttributeSet
{
	GENERATED_BODY()
...
public:
	...
	GAMEPLAYATTRIBUTE_PROPERTY_GETTER(UGASDemoAttributeSet, Health);
	...
	GAMEPLAYATTRIBUTE_PROPERTY_GETTER(UGASDemoAttributeSet, MaxHealth);
	...
	GAMEPLAYATTRIBUTE_PROPERTY_GETTER(UGASDemoAttributeSet, KnockbackForceTaken);
